...
export const CARD_SHOWS: CardShow[] = [
  ...
  {
    id: "gulf-coast-collectors-con",
    name: "Gulf Coast Collectors Con",
    city: "Tampa, FL",
    venue: "Tampa Convention Center",
    dateLabel: "May 16 - 17, 2026",
    status: "past",
    vendorCount: 110,
    attendeeEstimate: 4200,
  },
  {
    id: "midwest-vintage-classic",
    name: "Midwest Vintage Classic",
    city: "Columbus, OH",
    venue: "Greater Columbus Convention Center",
    dateLabel: "April 11 - 12, 2026",
    status: "past",
    vendorCount: 130,
    attendeeEstimate: 5100,
  },
  {
    id: "winter-hobby-showcase",
    name: "Winter Hobby Showcase",
    city: "Chicago, IL",
    venue: "McCormick Place",
    dateLabel: "February 21 - 22, 2026",
    status: "past",
    vendorCount: 175,
    attendeeEstimate: 6800,
  },
];
...
export type PendingVendorApproval = {
  id: string;
  businessName: string;
  categoryTags: VendorCategory[];
...
export const PENDING_VENDOR_APPROVALS: PendingVendorApproval[] = [
  {
    id: "pending-1",
    businessName: "Backyard Breaks & Boxes",
    categoryTags: ["modern", "supplies"],
    submittedDate: "2026-06-28",
    contactEmail: "info@backyardbreaks.example.com",
  },
  {
    id: "pending-2",
    businessName: "Sunset Slabs",
    categoryTags: ["vintage"],
    submittedDate: "2026-06-30",
    contactEmail: "contact@sunsetslabs.example.com",
  },
  {
    id: "pending-3",
    businessName: "Elite Eeveelutions",
    categoryTags: ["pokemon"],
    submittedDate: "2026-07-01",
    contactEmail: "hello@eliteeeveelutions.example.com",
  },
];
