  ...
  return (
    <main className="flex-1 px-6 py-12">
      <div className="mx-auto max-w-3xl">
        ...
        <h1 className="mb-1 text-2xl font-semibold">Manage Roles</h1>
        <p className="mb-6 text-sm text-gray-500 dark:text-gray-400">
          Search for a user and switch their role between customer, vendor, and admin.
        </p>
                  ...
                  {ROLES.map((role) => {
                    ...
                    return (
                      <button
                        ...
                        disabled={isCurrent || updatingPk === user.pk}
